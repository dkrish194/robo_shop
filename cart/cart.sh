...
log_cmd dnf module enable nodejs:20 -y
...
log INFO "downloading and unzipping cart code"
log_cmd curl -L -o /tmp/cart.zip https://roboshop-artifacts.s3.amazonaws.com/cart-v3.zip 
cd /app 
log_cmd unzip /tmp/cart.zip

log INFO "installing npm packages"
cd /app 
log_cmd npm install 

log INFO "copy cart service file to /etc/systemd/system/cart.service"
